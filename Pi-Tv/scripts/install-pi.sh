...
sudo apt-get update
sudo apt-get install -y mpv python3 python3-pip python3-evdev python3-tk dtv-scan-tables dvb5-tools
...
Tips:
  - See ~/pitv/Pi-Tv-Manual.txt for the full guide.
  - Connect a DVB-T/T2 aerial to the TV HAT.
  - Full-screen menu (set PITV_WINDOWED=1 for a small window).
  - Esc quits from the menu or while watching TV.
