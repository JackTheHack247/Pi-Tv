...
from .keyboard import KEY_DOWN, KEY_ENTER, KEY_QUIT, KEY_UP, KeyboardReader
...
class MpvPlayer:
    ...
    def __init__(self, channels: list[Channel], epg) -> None:
        if not channels:
    ...
    def run(self) -> str:
        ...
        Returns:
            "menu" to reopen country selection, "quit" to exit app.
        """
        self._start_mpv()
        try:
    ...
    def _start_mpv(self) -> None:
        ...
        if os.environ.get("PITV_NO_FULLSCREEN"):
            cmd.remove("--fs")
