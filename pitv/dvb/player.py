...
class DvbPlayer(MpvPlayer):
    ...
    def __init__(
        ...
        start_index: int = 0,
        show_on_screen_overlay: bool = True,
        embed_wid: int | None = None,
        theme: dict | None = None,
    ) -> None:
        super().__init__(channels, epg, embed_wid=embed_wid, theme=theme)
        self.index = start_index
        self.show_on_screen_overlay = show_on_screen_overlay
    ...
    def _play_current(self, show_overlay: bool) -> None:
        ...
        try:
            ...
            raise RuntimeError(
                "dvbv5-zap not found. Install: sudo apt install dvb5-tools"
            ) from exc
    ...
    def _overlay_loop(self) -> None:
        if not self.show_on_screen_overlay:
            return
