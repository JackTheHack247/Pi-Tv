...
class KeyboardReader:
    ...
    def _open_evdev(self) -> bool:
        ...
        # When the menu keyboard reader and the TV player swap modes, the
        # previous reader may still hold an exclusive grab for a few ms.
        # Retry briefly so we don't silently fall back to terminal input.
